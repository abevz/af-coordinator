...
Status: planned; implementation deferred pending operator prioritization.
...
Implementation issues are intentionally `deferred` while the operator compares
this track with Aion Forge Harness v2 Phase 4. Live status, claims,
